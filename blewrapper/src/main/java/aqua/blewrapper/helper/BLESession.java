...
public class BLESession extends LiveData {
    ...
    protected void onActive() {
        ...
        log(mContext.toString());
        boolean bindService = mContext.bindService(gattServiceIntent, mServiceConnection, Context.BIND_AUTO_CREATE);
        log("bind service" + bindService);
    ...
    public boolean connectTo(String deviceAddress) {
        ...
        Log.e("SESSION" ,"connect to" + mDeviceAddress);
        if (mBLEService != null) {
            ...
            if (ACTION_GATT_CONNECTED.equals(action)) {
                ...
                if (mGattCharacteristics != null) {
                    ...
                    for (Map.Entry<UUID, ArrayList<BluetoothGattCharacteristic>> entry : servicemap.entrySet()) {
                        ...
                        * */
                        if(key.toString().contains("180d") && value.size() > 0) {
                            characteristic = value.get(0);
                    ...
                    if ((charaProp | BluetoothGattCharacteristic.PROPERTY_NOTIFY) > 0) {
                        ...
                        Log.e("CHAR", "onReceive: char UUID"+characteristic.getUuid().toString());
